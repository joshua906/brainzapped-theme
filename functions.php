...
function bz_js() {
	...
	/*wp_enqueue_scripts('bootstrap_min', get_template_directory_uri() . '/js/bootstrap.min.js');
	wp_enqueue_scripts('bootstrap_js', get_template_directory_uri() . '/js/bootstrap.js');-->*/
}
